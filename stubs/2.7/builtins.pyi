...
class int(SupportsInt, SupportsFloat, SupportsAbs[int]):
    ...
    @overload
    def __init__(self, x: unicode, base: int = 10) -> None: ...
    @overload
...
class unicode(Sequence[unicode]):
    ...
    def __init__(self, o: object) -> None: ...
    @overload
    def __init__(self, o: str, encoding: str = None, errors: str = 'strict') -> None: ...
    @overload
    def __init__(self, o: str, encoding: unicode = None, errors: unicode = 'strict') -> None: ...
    @overload
    def __init__(self, o: bytearray, encoding: str = None, errors: str = 'strict') -> None: ...
    @overload
    ...
    def endswith(self, suffix: unicode, start: int = 0,
                 end: int = None) -> bool: ...  # TODO tuple suffix; None value for int
    ...
    def lstrip(self, chars: unicode = None) -> unicode: ...
    def partition(self, sep: unicode) -> Tuple[unicode, unicode, unicode]: ...
    def replace(self, old: unicode, new: unicode, count: int = -1) -> unicode: ...
    ...
    def rsplit(self, sep: unicode = None, maxsplit: int = -1) -> List[unicode]: ...
    def rstrip(self, chars: unicode = None) -> unicode: ...
    def split(self, sep: unicode = None, maxsplit: int = -1) -> List[unicode]: ...
    def splitlines(self, keepends: bool = False) -> List[unicode]: ...
    def startswith(self, prefix: unicode, start: int = 0,
                   end: int = None) -> bool: ...  # TODO tuple prefix; None value for int
    def strip(self, chars: unicode = None) -> unicode: ...
    def swapcase(self) -> unicode: ...
    def title(self) -> unicode: ...
    def translate(self, table: Dict[int, Any]) -> unicode: ...
...
class str(Sequence[str]):
    ...
    def center(self, width: int, fillchar: Union[str, bytearray] = None) -> str: ...
    ...
    def ljust(self, width: int, fillchar: Union[str, bytearray] = None) -> str: ...
    def lower(self) -> str: ...
    @overload
    def lstrip(self, chars: Union[str, bytearray] = None) -> str: ...
    @overload
    ...
    def rjust(self, width: int, fillchar: Union[str, bytearray] = None) -> str: ...
    @overload
    ...
    def rpartition(self, sep: unicode) -> Tuple[unicode, unicode, unicode]: ...
    @overload
    def rsplit(self, sep: Union[str, bytearray] = None, maxsplit: int = -1) -> List[str]: ...
    @overload
    def rsplit(self, sep: unicode, maxsplit: int = -1) -> List[unicode]: ...
    @overload
    def rstrip(self, chars: Union[str, bytearray] = None) -> str: ...
    @overload
    def rstrip(self, chars: unicode) -> unicode: ...
    @overload
    def split(self, sep: Union[str, bytearray] = None, maxsplit: int = -1) -> List[str]: ...
    @overload
    def split(self, sep: unicode, maxsplit: int = -1) -> List[unicode]: ...
    def splitlines(self, keepends: bool = False) -> List[str]: ...
    def startswith(self, prefix: Union[unicode, bytearray]) -> bool: ...
    @overload
    def strip(self, chars: Union[str, bytearray] = None) -> str: ...
    @overload
    def strip(self, chars: unicode) -> unicode: ...
    def swapcase(self) -> str: ...
    def title(self) -> str: ...
    @overload
    def translate(self, table: Union[str, bytearray]) -> str: ...
    @overload
...
class bytearray(Sequence[int]):
    ...
    @overload
    def center(self, width: int, fillchar: str = None) -> bytearray: ...
    @overload
    def center(self, width: int, fillchar: bytearray = None) -> bytearray: ...
    @overload
    ...
    @overload
    def ljust(self, width: int, fillchar: str = None) -> bytearray: ...
    @overload
    def ljust(self, width: int, fillchar: bytearray = None) -> bytearray: ...
    def lower(self) -> bytearray: ...
    @overload
    def lstrip(self, chars: str = None) -> bytearray: ...
    @overload
    def lstrip(self, chars: bytearray = None) -> bytearray: ...
    @overload
    ...
    @overload
    def replace(self, old: str, new: str, count: int = -1) -> bytearray: ...
    @overload
    def replace(self, old: bytearray, new: bytearray, count: int = -1) -> bytearray: ...
    @overload
    ...
    @overload
    def rjust(self, width: int, fillchar: str = None) -> bytearray: ...
    @overload
    def rjust(self, width: int, fillchar: bytearray = None) -> bytearray: ...
    @overload
    ...
    @overload
    def rsplit(self, sep: str = None, maxsplit: int = -1) -> List[bytearray]: ...
    @overload
    def rsplit(self, sep: bytearray = None,
               maxsplit: int = -1) -> List[bytearray]: ...
    @overload
    def rstrip(self, chars: str = None) -> bytearray: ...
    @overload
    def rstrip(self, chars: bytearray = None) -> bytearray: ...
    @overload
    ...
    @overload
    def strip(self, chars: str = None) -> bytearray: ...
    @overload
    def strip(self, chars: bytearray = None) -> bytearray: ...
...
class list(Sequence[_T], Reversible[_T], Generic[_T]):
    ...
    def index(self, object: _T, start: int = 0, stop: int = Undefined(int)) -> int: ...
...
class frozenset(AbstractSet[_T], Generic[_T]):
    ...
    def __or__(self, s: AbstractSet[_T]) -> frozenset[_T]: ...
    def __sub__(self, s: AbstractSet[_T]) -> frozenset[_T]: ...
    def __xor__(self, s: AbstractSet[_T]) -> frozenset[_T]: ...
    # TODO more set operations
...
def id(o: object) -> int: ...
def input(prompt: unicode = None) -> Any: ...
...
@overload
def open(file: str, mode: str = 'r', buffering: int = -1) -> BinaryIO: ...
@overload
def open(file: unicode, mode: str = 'r', buffering: int = -1) -> BinaryIO: ...
@overload
def open(file: int, mode: str = 'r', buffering: int = -1) -> BinaryIO: ...
@overload
...
def raw_input(prompt: unicode = None) -> str: ...
...
class WindowsError(OSError): ...  # TODO Windows-only
# TODO: VMSError?
