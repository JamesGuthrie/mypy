...
class str(Sequence[str]):
    ...
    def __init__(self, o: object) -> None: ...
    @overload
    def __init__(self, o: _byte_types, encoding: str = None, errors: str = 'strict') -> None: ...
...
class bytes(ByteString):
    ...
    def rsplit(self, sep: _byte_types = None, maxsplit: int = -1) -> List[bytes]: ...
...
class bytearray(MutableSequence[int], ByteString):
    ...
    def partition(self, sep: _byte_types) -> Tuple[bytearray, bytearray, bytearray]: ...
    def replace(self, old: _byte_types, new: bytes, count: int = -1) -> bytearray: ...
    def rfind(self, sub: _byte_types, start: int = 0, end: int = 0) -> int: ...
    def rindex(self, sub: _byte_types, start: int = 0, end: int = 0) -> int: ...
    def rjust(self, width: int, fillchar: _byte_types = None) -> bytearray: ...
    def rpartition(self, sep: _byte_types) -> Tuple[bytearray, bytearray, bytearray]: ...
    def rsplit(self, sep: _byte_types = None, maxsplit: int = -1) -> List[bytearray]: ...
    def rstrip(self, chars: _byte_types = None) -> bytearray: ...
    def split(self, sep: _byte_types = None, maxsplit: int = -1) -> List[bytearray]: ...
...
class set(MutableSet[_T], Generic[_T]):
    ...
    def __or__(self, s: AbstractSet[_T]) -> set[_T]: ...
    def __ior__(self, s: AbstractSet[_T]) -> set[_T]: ...
    def __sub__(self, s: AbstractSet[Any]) -> set[_T]: ...
    def __isub__(self, s: AbstractSet[Any]) -> set[_T]: ...
    def __xor__(self, s: AbstractSet[_T]) -> set[_T]: ...
    def __ixor__(self, s: AbstractSet[_T]) -> set[_T]: ...
