...
class Retry:
    ...
    def __init__(self, total=10, connect=None, read=None, redirect=None, method_whitelist=Undefined, status_forcelist=None, backoff_factor=0, raise_on_redirect=True, _observed_errors=0): ...
    def new(self, **kw): ...
    @classmethod
